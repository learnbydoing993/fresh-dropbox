...
export default function CreateButton(props: CreateProps) {
  ...
  return(
    <button type="button" class="inline-flex items-center gap-1.5 border border-gray-400 bg-gray-400 px-5 py-2.5 text-center text-sm font-medium text-white shadow-sm transition-all hover:border-gray-500 hover:bg-gray-500 focus:ring focus:ring-gray-500" onClick={openModal}>
