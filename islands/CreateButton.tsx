...
export default function CreateButton(props: CreateProps) {
  ...
  return(
    <button type="button" class="inline-flex items-center gap-1.5 border border-blue-400 bg-blue-400 px-5 py-2.5 text-center text-sm font-medium text-white shadow-sm transition-all hover:border-blue-500 hover:bg-blue-500 focus:ring focus:ring-blue-500" onClick={openModal}>
